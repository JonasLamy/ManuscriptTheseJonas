...
\newcommand{\chapIntroN}{1}
\newcommand{\chapContextN}{2}
\newcommand{\chapSOTAN}{3}
\newcommand{\chapBenchN}{4}
\newcommand{\chapAnalysisN}{5}
\newcommand{\chapReproN}{6}
\newcommand{\chapEndN}{7}
